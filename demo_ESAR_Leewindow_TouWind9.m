...
for iii=3:2:11
    ...
    path=strcat('E:\20200430Experiment\POLSAR Images\ESAR_Oberpfaffenhofen1200-1300\LeeWindowTouWind9\',int2str(iii),'\T3\');
...
saveas(gcf,'ESARLeeWindTouWind9.bmp')
%%

% save ESARLeeWindTouWind9.mat
