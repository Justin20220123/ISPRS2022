...
for iii=3:2:11
    ...
    path=strcat('E:\20200430Experiment\POLSAR Images\ESAR_Oberpfaffenhofen1200-1300\LeeWindowTouWind17\',int2str(iii),'\T3\');
...
saveas(gcf,'ESARLeeWindTouWind17.bmp')
%%

% save ESARLeeWindTouWind17.mat
